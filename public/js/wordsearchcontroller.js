...
function WordSearchController(gameId, listId, solveId, newGameId, instructionsId, themeId) {
	...
	var searchTypes = {
		...
		"Nawales": [["batz", "aj", "ix", "tzikin"],
			...
			["kan", "kat", "keej", "imox"],
			["ajpu", "tzi", "ajmaq", "kawoq"],
			["iq", "qanil", "noj", "nawales"]],

		"Numeros": [["majbal", "jun", "Keb", "oxib"],
			["kajib", "job", "waqib", "wuqub"],
			["wajxaqib", "belejeb", "lajuj", "julajuj"],
			["kablajuj", "oxlajuj", "kajlajuj", "jolajuj"],
			["waqlajuj", "wajxaqlajuj", "belejlajuj", "Jukal juwinaq"]]
